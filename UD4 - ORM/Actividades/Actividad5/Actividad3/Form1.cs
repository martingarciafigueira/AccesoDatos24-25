...
namespace Actividad3
{
    public partial class Form1 : Form
    {
        ...
        private void btnInsertarFutbolista_Click(object sender, EventArgs e)
        {
            ...
            cbEquipoSeleccionado.SelectedIndex = 0;
        }

        public void InsertarFutbolista(Futbolista nuevo)
        {
            var consulta = $@"INSERT INTO Futbolistas(Codigo, Nombre, CodigoEquipo) VALUES('{nuevo.Codigo}', '{nuevo.Nombre}', '{nuevo.CodigoEquipo}')";
